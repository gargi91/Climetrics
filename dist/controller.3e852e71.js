...
const init = async function () {
  try {
    ...
    _citiesView.default.render(model.state.topCities);
  } catch (err) {
    console.error(`🥵😱 ${err}`);
  }
...
init();
},{"chart.js/auto":"66afc3fc036ac0a9124314181ca6daf9","./model.js":"aabf248f40f7693ef84a0cb99f385d1f","./views/citiesView":"9bdacaa3dd400962d700caddac76d41f","./views/reportView":"ff8d0b5abc33481142ff72d5db7c4a23"}],"66afc3fc036ac0a9124314181ca6daf9":[function(require,module,exports) {
...
const loadData = async function () {
  try {
    ...
    const cityWeatherData = resCitiesWeatherData.map(w => {
      var _w$value;

      return (_w$value = w.value) === null || _w$value === void 0 ? void 0 : _w$value.current;
    });
    ...
    state.topCities.forEach((city, index) => {
      ...
      city.report = {
        ...
        icon: _helper.weatherIcons[cityWeatherData[index].weather[0].icon]
      };
    });
  } catch (err) {
    console.error(`👽👽👽${err}`);
...
},{"./config.js":"09212d541c5c40ff2bd93475a904f8de"}],"9bdacaa3dd400962d700caddac76d41f":[function(require,module,exports) {
"use strict";
...
},{"./bundle-manifest":"ba8df6b71e73837c465d69bebde6e64d"}],"ff8d0b5abc33481142ff72d5db7c4a23":[function(require,module,exports) {
"use strict";
...
class ReportView extends _view.default {
  ...
  updateUI(data) {
    ...
    console.log(windSpeed); // Create a new Gauge
